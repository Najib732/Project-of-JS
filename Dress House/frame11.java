...
public class frame11 extends JFrame  {
   ...
   p1.add(b3);
    ...
    im1=new ImageIcon(getClass().getResource("Image/girl/summer/s6.jpg"));
    b4=new JButton(im1);
    b4.setBounds(20,105,118,177);
    b4.setBorder(null);
    p2.add(b4);

    im2=new ImageIcon(getClass().getResource("Image/girl/summer/s7.jpg"));
    b5=new JButton(im2);
    b5.setBounds(155,105,118,177);
    b5.setBorder(null);
    p2.add(b5);

    im2=new ImageIcon(getClass().getResource("Image/girl/summer/s8.jpg"));
    b6=new JButton(im2);
    b6.setBounds(290,105,118,177);
    b2.setBorder(null);
    p2.add(b6);

    im2=new ImageIcon(getClass().getResource("Image/girl/summer/s9.jpg"));
    b7=new JButton(im2);
    b7.setBounds(420,105,118,177);
    b7.setBorder(null);
    p2.add(b7);

    im2=new ImageIcon(getClass().getResource("Image/girl/summer/s10.jpg"));
    b8=new JButton(im2);
...
public void mouseExited(MouseEvent evt){
    ...
    b1.addActionListener(new ActionListener() {
     ...
     b4.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
       int response=JOptionPane.showConfirmDialog(rootPane,"price:4500 taka \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
  ...
  b5.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
     int response=JOptionPane.showConfirmDialog(rootPane,"price:2700 taka \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
     if(response==JOptionPane.YES_OPTION){
     setVisible(false);
     pay frame = new pay();
     frame.setVisible(true);
...
b7.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:2290 taka \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
...
b8.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:5000 taka  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
