...
public class frame18 extends JFrame  {
   ...
   im4=new ImageIcon("Image/banner/n.png");
   b11=new JButton();  
   ...
   p1.add(b3);
    ...
    im1=new ImageIcon(getClass().getResource("Image/children/winter/w6.jpeg"));
    b4=new JButton(im1);
    b4.setBounds(20,105,118,177);
    p2.add(b4);

    im2=new ImageIcon(getClass().getResource("Image/children/winter/w7.jpeg"));
    b5=new JButton(im2);
    b5.setBounds(155,105,118,177);
    p2.add(b5);

    im2=new ImageIcon(getClass().getResource("Image/children/winter/w8.jpeg"));
    b6=new JButton(im2);
    b6.setBounds(290,105,118,177);
    p2.add(b6);

    im2=new ImageIcon(getClass().getResource("Image/children/winter/w9.jpeg"));
    b7=new JButton(im2);
    b7.setBounds(420,105,118,177);
    p2.add(b7);

    im2=new ImageIcon(getClass().getResource("Image/children/winter/w10.jpeg"));
    b8=new JButton(im2);
...
public void mouseExited(MouseEvent evt){
    ...
    b1.addActionListener(new ActionListener() {
     ...
     b4.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
       int response=JOptionPane.showConfirmDialog(rootPane,"price:1100 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
  ...
  b5.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
     int response=JOptionPane.showConfirmDialog(rootPane,"price:900 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
     if(response==JOptionPane.YES_OPTION){
     setVisible(false);
     pay frame = new pay();
     frame.setVisible(true);
...
b6.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:1400 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
...
b7.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:700 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
