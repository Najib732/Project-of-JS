...
public class frame17 extends JFrame  {
   ...
   p1.add(b3);
    ...
    im1=new ImageIcon(getClass().getResource("Image/children/winter/w1.jpeg"));
    b4=new JButton(im1);
    b4.setBounds(20,105,118,177);
    p2.add(b4);

    im2=new ImageIcon(getClass().getResource("Image/children/winter/w2.jpeg"));
    b5=new JButton(im2);
    b5.setBounds(155,105,118,177);
    p2.add(b5);

    im2=new ImageIcon(getClass().getResource("Image/children/winter/w3.jpeg"));
    b6=new JButton(im2);
    b6.setBounds(290,105,118,177);
    p2.add(b6);

    im2=new ImageIcon(getClass().getResource("Image/children/winter/w4.jpeg"));
    b7=new JButton(im2);
    b7.setBounds(420,105,118,177);
    p2.add(b7);

    im2=new ImageIcon(getClass().getResource("Image/children/winter/w5.jpeg"));
    b8=new JButton(im2);
...
b10.addMouseListener(new MouseAdapter(){
    ...
    public void mouseEntered(MouseEvent evt){
      ...
      b10.setBackground(Color.decode("#87CEEB"));
  }	
...
public void mouseExited(MouseEvent evt){
  ...
  b5.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
     int response=JOptionPane.showConfirmDialog(rootPane,"price:980 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
     if(response==JOptionPane.YES_OPTION){
     setVisible(false);
     pay frame = new pay();
     frame.setVisible(true);
...
b7.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:800 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
...
b8.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:1050 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
