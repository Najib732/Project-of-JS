...
public class frame5 extends JFrame  {
   ...
   public ImageIcon im1,im2,im3,im4,imb4;
    JLabel l1;
    /**
     * 
     */
   ...
   p1.add(b3);
    ...
    im1=new ImageIcon(getClass().getResource("Image/boy/summer/b1.png"));
    b4=new JButton(im1);
    b4.setBounds(20,105,118,177);
    p2.add(b4);

    im2=new ImageIcon(getClass().getResource("Image/boy/summer/s2.png"));
    b5=new JButton(im2);
    b5.setBounds(155,105,118,177);
    p2.add(b5);

    im2=new ImageIcon(getClass().getResource("Image/boy/summer/s3.png"));
    b6=new JButton(im2);
    b6.setBounds(290,105,118,177);
    p2.add(b6);

    im2=new ImageIcon(getClass().getResource("Image/boy/summer/s4.jpg"));
    b7=new JButton(im2);
    b7.setBounds(420,105,118,177);
    p2.add(b7);

    im2=new ImageIcon(getClass().getResource("Image/boy/summer/s5.jpg"));
    b8=new JButton(im2);
...
public void mouseExited(MouseEvent evt){
    ...
    b1.addActionListener(new ActionListener() {
     ...
     b4.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
       int response=JOptionPane.showConfirmDialog(rootPane,"price:1000 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
  ...
  b5.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
     int response=JOptionPane.showConfirmDialog(rootPane,"price:1200 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
     if(response==JOptionPane.YES_OPTION){
...
b8.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:1500 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
