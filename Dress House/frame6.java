...
public class frame6 extends JFrame  {
    ...
    im1=new ImageIcon(getClass().getResource("Image/boy/summer/s6.jpg"));
    b4=new JButton(im1);
    b4.setBounds(20,105,118,177);
    b1.setBorder(null);
    p2.add(b4);

    im2=new ImageIcon(getClass().getResource("Image/boy/summer/s7.jpg"));
    b5=new JButton(im2);
    b5.setBounds(155,105,118,177);
    b2.setBorder(null);
    p2.add(b5);

    im2=new ImageIcon(getClass().getResource("Image/boy/summer/s8.jpg"));
    b6=new JButton(im2);
    b6.setBounds(290,105,118,177);
    b2.setBorder(null);
    p2.add(b6);

    im2=new ImageIcon(getClass().getResource("Image/boy/summer/s9.jpg"));
    b7=new JButton(im2);
    b7.setBounds(420,105,118,177);
    b2.setBorder(null);
    p2.add(b7);

    im2=new ImageIcon(getClass().getResource("Image/boy/summer/b1.png"));
    b8=new JButton(im2);
    ...
    b1.addActionListener(new ActionListener() {
     ...
     b4.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
       int response=JOptionPane.showConfirmDialog(rootPane,"price:1350 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
