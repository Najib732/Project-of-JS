...
public class frame15 extends JFrame  {
   ...
   p1.add(b3);
    ...
    im1=new ImageIcon(getClass().getResource("Image/children/summer/s1.jpeg"));
    b4=new JButton(im1);
    b4.setBounds(20,105,118,177);
    p2.add(b4);

    im2=new ImageIcon(getClass().getResource("Image/children/summer/s2.jpeg"));
    b5=new JButton(im2);
    b5.setBounds(155,105,118,177);
    p2.add(b5);

    im2=new ImageIcon(getClass().getResource("Image/children/summer/s3.jpeg"));
    b6=new JButton(im2);
    b6.setBounds(290,105,118,177);
    p2.add(b6);

    im2=new ImageIcon(getClass().getResource("Image/children/summer/s4.jpeg"));
    b7=new JButton(im2);
    b7.setBounds(420,105,118,177);
    p2.add(b7);

    im2=new ImageIcon(getClass().getResource("Image/children/summer/s5.jpeg"));
    b8=new JButton(im2);
    ...
    b1.addActionListener(new ActionListener() {
     ...
     b4.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent ae) {
       int response=JOptionPane.showConfirmDialog(rootPane,"price:550 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
...
b8.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:300 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
