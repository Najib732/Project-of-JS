...
public class frame9 extends JFrame  {
   ...
   p1.add(b11);
        ...
        im1=new ImageIcon(getClass().getResource("Image/girl/summer/summer.gif"));
        b4=new JButton(im1);
        b4.setBounds(100,95,250,150);
        p2.add(b4);

        im2=new ImageIcon(getClass().getResource("Image/girl/winter/winter.gif"));
        b5=new JButton(im2);
        b5.setBounds(360,95,250,150);
        p2.add(b5);
