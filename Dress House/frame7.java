...
public class frame7 extends JFrame  {
   ...
   p1.add(b11);
    ...
    im1=new ImageIcon(getClass().getResource("Image/boy/winter/w1.jpg"));
    b4=new JButton(im1);
    b4.setBounds(20,105,118,177);
    b1.setBorder(null);
    p2.add(b4);

    im2=new ImageIcon(getClass().getResource("Image/boy/winter/w2.jpg"));
    b5=new JButton(im2);
    b5.setBounds(155,105,118,177);
    b2.setBorder(null);
    p2.add(b5);

    im2=new ImageIcon(getClass().getResource("Image/boy/winter/w3.jpg"));
    b6=new JButton(im2);
    b6.setBounds(290,105,118,177);
    b2.setBorder(null);
    p2.add(b6);

    im2=new ImageIcon(getClass().getResource("Image/boy/winter/w4.jpg"));
    b7=new JButton(im2);
    b7.setBounds(420,105,118,177);
    b2.setBorder(null);
    p2.add(b7);

    im2=new ImageIcon(getClass().getResource("Image/boy/winter/w5.jpg"));
    b8=new JButton(im2);
...
public void mouseExited(MouseEvent evt){
  ...
  b5.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent ae) {
     int response=JOptionPane.showConfirmDialog(rootPane,"price:3900 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
     if(response==JOptionPane.YES_OPTION){
     setVisible(false);
     pay frame = new pay();
     frame.setVisible(true);
...
b6.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:2000 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
...
b7.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:1750 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
...
b8.addActionListener(new ActionListener() {
  public void actionPerformed(ActionEvent ae) {
   int response=JOptionPane.showConfirmDialog(rootPane,"price:2050 taka \n size available:M,X,XL.  \n Delivery:within 3-7days  \n","CONFIRM PAYMENT",JOptionPane.YES_NO_OPTION );
   if(response==JOptionPane.YES_OPTION){
   setVisible(false);
   pay frame = new pay();
   frame.setVisible(true);
